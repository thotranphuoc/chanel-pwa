...
export class DbService {
    ...
    logAdd(ID_USER: string, NAME: string,ROLE: string,ACTIVITY: string ){
        let url='https://kiguinhadat.com.vn/webservice/service/service_test.php?action=InsertLogActivity&ID_USER='+ID_USER+'&NAME=' +NAME+ '&ROLE='+ ROLE +'&ACTIVITY='+ACTIVITY;
    ...
    getHistory()
    {
        let url='https://kiguinhadat.com.vn/webservice/service/service_test.php?action=GetLogActivity';
